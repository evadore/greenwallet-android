...
public class MediaLinks
{
    ...
    public static final String AWALLET_FAQ_URL = "https://www.evadore.io/";
    public static final String AWALLET_GITHUB = "https://evadore.io";
    public static final String AWALLET_EMAIL1 = "feedback+android";
    public static final String AWALLET_EMAIL2 = "evadore.io";
    public static final String AWALLET_SUBJECT = "GreenWallet Android Help";
